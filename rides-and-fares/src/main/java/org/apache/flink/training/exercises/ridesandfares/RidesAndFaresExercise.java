...
public class RidesAndFaresExercise {
    ...
    public static class EnrichmentFunction
        ...
        private transient ValueState<TaxiFare> taxiFare;

        @Override
        public void open(Configuration config) {
            taxiRide = getRuntimeContext().getState(new ValueStateDescriptor<>("taxiRide", TaxiRide.class));
            taxiFare = getRuntimeContext().getState(new ValueStateDescriptor<>("taxiFare", TaxiFare.class));
        }
